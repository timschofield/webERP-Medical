...
echo "<TABLE CELLPADDING=2><TR><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Account</B></TD><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Name</B></TD><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Amount<BR>in " . $_SESSION['SuppTrans']->CurrCode . "</B></TD><TD BGCOLOR =#800000><FONT COLOR=#ffffff><B>Job</B></TD><TD BGCOLOR =#800000><FONT COLOR=#ffffff><B>Narrative</B></TD></TR>";

$TotalGLValue=0;

foreach ( $_SESSION['SuppTrans']->GLCodes as $EnteredGLCode){

	echo "<TR><TD>" . $EnteredGLCode->GLCode . "</TD><TD>" . $EnteredGLCode->GLActName . "</TD><TD ALIGN=RIGHT>" . number_format($EnteredGLCode->Amount,2) . "</TD><TD>" .$EnteredGLCode->JobRef . "</TD><TD>" . $EnteredGLCode->Narrative . "</TD><TD><A HREF='" . $_SERVER['PHP_SELF'] . "?" . SID . "Delete=" . $EnteredGLCode->Counter . "'>Delete</A></TD></TR>";
	...
	if ($i>15){
		$i=0;
		echo "<TR><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Account</B></TD><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Name</B></TD><TD BGCOLOR=#800000><FONT COLOR=#ffffff><B>Amount<BR>in " . $_SESSION['SuppTrans']->CurrCode . "</B></TD><TD BGCOLOR =#800000><FONT COLOR=#ffffff><B>Job</B></TD><TD BGCOLOR =#800000><FONT COLOR=#ffffff><B>Narrative</B></TD></TR>";
	}
}
...
echo "<TABLE>";
echo "<TR><TD>Account Code:</TD><TD><input type='Text' name='GLCode' SIZE=12 MAXLENGTH=11 value=" .  $_POST['GLCode'] . "></TD></TR>";
echo "<TR><TD>Account Selection:<BR><FONT SIZE=1>If you know the code enter it above<BR>otherwise select the account from the list</FONT></TD><TD><SELECT Name='AcctSelection'>";
...
echo "<TR><TD>Contract Ref:</TD><TD><input type='Text' name='JobRef' SIZE=21 MAXLENGTH=20 value=" . $_POST['JobRef'] . "> <a target='_blank' href='$rootpath/ContractsList.php?" . SID . "'>View Open Contracts/Jobs</a></TD></TR>";
echo "<TR><TD>Narrative:</TD><TD><TEXTAREA NAME=Narrative COLS=40 ROWS=2>" .  $_POST['Narrative'] . "</TEXTAREA></TD></TR></TABLE>";
