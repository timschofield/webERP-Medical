...
if (!isset($ManufacturerID)) {
	...
	echo '<button tabindex="3" type="submit" name="Create">' . _('Create New Manufacturer') . '</button>';
	echo '</div></form>';
	include('includes/footer.inc');
	exit;
...
if (isset($_POST['Create'])) {
	echo '</table><br /><div class="centre"><button tabindex="12" type="submit" name="submit">' . _('Insert New Manufacturer') . '</button></div>';
	echo '</form>';
