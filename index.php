				...
				<table width="100%" >
					...
					<td class="menu_group_items">  <!-- Orders transaction options -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/KCMCPatientDeposit.php?New=True">' . _('Deposit Received From Patient') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/KCMCOtherMedicalServices.php?New=True">' . _('Other Medical Services') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/KCMCPharmacy.php?New=True">' . _('Sales of Drugs') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/KCMCInPatientBilling.php?New=True">' . _('Billing for Inpatient Drugs and Services') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
