...
include('includes/header.inc');
	...
	echo '<table cellpadding="2" class="selection">
		...
		echo '<table class="selection"><tr><th colspan="5" class="header">' . _('Material Requirements For this Work Order') . '</th></tr>';
		echo '<tr><th colspan="4" class="header">' . _('Stock Issued From') . ' - ' . $LocRow['locationname'] . '</th></tr>';
