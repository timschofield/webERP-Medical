...
echo '<tr><th colspan="3" class="header">' . _('General Settings') . '</th></tr>';
echo $TableHeader;

// DefaultDateFormat
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Date Format') . ':</td>
...
// DefaultTheme
echo '<tr style="outline: solid #A49999 1px"><td>' . _('New Users Default Theme') . ':</td>
...
echo '<tr><th colspan="3" class="header">' . _('Accounts Receivable/Payable Settings') . '</th></tr>';

// PastDueDays1
echo '<tr style="outline: solid #A49999 1px"><td>' . _('First Overdue Deadline in (days)') . ':</td>
...
// PastDueDays2
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Second Overdue Deadline in (days)') . ':</td>
...
// DefaultCreditLimit
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Credit Limit') . ':</td>
...
// Check Credit Limits
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Check Credit Limits') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Show Settled Last Month') . ':</td>
...
//RomalpaClause
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Romalpa Clause') . ':</td>
...
// QuickEntries
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Quick Entries') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Frequently Ordered Items') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Sales Order Allows Same Item Multiple Times') . ':</td>
...
//'RequirePickingNote'
echo '<tr style="outline: solid #A49999 1px"><td>' . _('A picking note must be produced before an order can be delivered') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Auto Update Exchange Rates Daily') . ':</td>
	<td><select name="X_UpdateCurrencyRatesDaily">
	<option '.($_SESSION['UpdateCurrencyRatesDaily']!='0'?'selected ':'').'value="1">'._('Automatic') . '</option>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Format of Packing Slips') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Invoice Orientation') . ':</td>
...
//Blind packing note
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Show company details on packing slips') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Working Days on a Week') . ':</td>
...
// DispatchCutOffTime
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Dispatch Cut-Off Time') . ':</td>
	<td><select name="X_DispatchCutOffTime">';
for ($i=0; $i < 24; $i++ )
	echo '<option '.($_SESSION['DispatchCutOffTime'] == $i?'selected ':'').'value="'.$i.'">'.$i . '</option>';
echo '</select></td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Allow Sales Of Zero Cost Items') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Controlled Items Must Exist For Crediting') . ':</td>
...
$result = DB_query($sql,$db,$ErrMsg);
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Price List') . ':</td>';
echo '<td><select name="X_DefaultPriceList">';
if( DB_num_rows($result) == 0 ) {
	echo '<option selected="True" value="">'._('Unavailable') . '</option>';
} else {
	while( $row = DB_fetch_array($result) ) {
		echo '<option '.($_SESSION['DefaultPriceList'] == $row['typeabbrev']?'selected ':'').'value="'.$row['typeabbrev'].'">'.$row['sales_type'] . '</option>';
	}
}
echo '</select></td>
...
$result = DB_query($sql,$db,$ErrMsg);
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Shipper') . ':</td>';
...
// DoFreightCalc
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Do Freight Calculation') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Apply freight charges if an order is less than') . ':</td>
...
// AutoDebtorNo
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Create Debtor Codes Automatically') . ':</td>
	<td><select name="X_AutoDebtorNo">';

if ($_SESSION['AutoDebtorNo']==0) {
	echo '<option selected="True" value=0>' . _('Manual Entry') . '</option>';
	echo '<option value=1>' . _('Automatic') . '</option>';
} else {
	echo '<option selected="True" value=1>' . _('Automatic') . '</option>';
...
$result = DB_query($sql,$db,$ErrMsg);
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Tax Category') . ':</td>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('TaxAuthorityReferenceName') . ':</td>
...
$result = DB_query($sql,$db,$ErrMsg);
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Country Of Operation') . ':</td>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Number Of Periods Of StockUsage') . ':</td>
	<td><select name="X_NumberOfPeriodsOfStockUsage">';
for ($i=1; $i <= 12; $i++ )
	echo '<option '.($_SESSION['NumberOfPeriodsOfStockUsage'] == $i?'selected ':'').'value="'.$i.'">'.$i . '</option>';
...
//Show values on GRN
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Show order values on GRN') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Check Quantity Charged vs Deliver Qty') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Check Price Charged vs Order Price') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Allowed Over Charge Proportion') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Allowed Over Receive Proportion') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Purchase Order Allows Same Item Multiple Times') . ':</td>
...
$MonthNames = array( 1=>_('January'),
			...
			11=>_('November'),
			12=>_('December') );
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Financial Year Ends On') . ':</td>
...
//PageLength
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Report Page Length') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Maximum Number of Records to Show') . ':</td>
...
//MaxImageSize
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Maximum Size in KB of uploaded images') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Number Of Month Must Be Shown') . ':</td>
...
//$part_pics_dir
echo '<tr style="outline: solid #A49999 1px"><td>' . _('The directory where images are stored') . ':</td>
...
while (false !== ($DirEntry = $DirHandle->read()) ){
	...
	if (is_dir($CompanyDirectory . $DirEntry)
		...
		if ($_SESSION['part_pics_dir'] == $CompanyDirectory . $DirEntry){
			echo '<option selected="True" value="' . $DirEntry . '">' . $DirEntry . '</option>';
		} else {
...
//$reports_dir
echo '<tr style="outline: solid #A49999 1px"><td>' . _('The directory where reports are stored') . ':</td>
...
// HTTPS_Only
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Only allow secure socket connections') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Perform Database Maintenance At Logon') . ':</td>
	<td><select name="X_DB_Maintenance">';
	if ($_SESSION['DB_Maintenance']=='1'){
		echo '<option selected="True" value="1">'._('Daily') . '</option>';
	} else {
		echo '<option value="1">'._('Daily') . '</option>';
	}
	if ($_SESSION['DB_Maintenance']=='7'){
		echo '<option selected="True" value="7">'._('Weekly') . '</option>';
	} else {
		echo '<option value="7">'._('Weekly') . '</option>';
	}
	if ($_SESSION['DB_Maintenance']=='30'){
		echo '<option selected="True" value="30">'._('Monthly') . '</option>';
	} else {
		echo '<option value="30">'._('Monthly') . '</option>';
	}
	if ($_SESSION['DB_Maintenance']=='0'){
		echo '<option selected="True" value="0">'._('Never') . '</option>';
	} else {
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Wiki application') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Wiki Path') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Geocode Customers and Suppliers') . ':</td>
        <td><select name="X_geocode_integration">';
if ($_SESSION['geocode_integration']==1){
        echo  '<option selected="True" value="1">' . _('Geocode Integration Enabled') . '</option>';
        echo  '<option value="0">' . _('Geocode Integration Disabled') . '</option>';
} else {
        echo  '<option selected="True" value="0">' . _('Geocode Integration Disabled') . '</option>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Extended Customer Information') . ':</td>
        <td><select name="X_Extended_CustomerInfo">';
if ($_SESSION['Extended_CustomerInfo']==1){
        echo  '<option selected="True" value="1">' . _('Extended Customer Info Enabled') . '</option>';
        echo  '<option value="0">' . _('Extended Customer Info Disabled') . '</option>';
} else {
        echo  '<option selected="True" value="0">' . _('Extended Customer Info Disabled') . '</option>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Extended Supplier Information') . ':</td>
        <td><select name="X_Extended_SupplierInfo">';
if ($_SESSION['Extended_SupplierInfo']==1){
        echo  '<option selected="True" value="1">' . _('Extended Supplier Info Enabled') . '</option>';
        echo  '<option value="0">' . _('Extended Supplier Info Disabled') . '</option>';
} else {
        echo  '<option selected="True" value="0">' . _('Extended Supplier Info Disabled') . '</option>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Prohibit GL Journals to Control Accounts') . ':</td>
	<td><select name="X_ProhibitJournalsToControlAccounts">';
if ($_SESSION['ProhibitJournalsToControlAccounts']=='1'){
		echo  '<option selected="True" value="1">' . _('Prohibited') . '</option>';
		echo  '<option value="0">' . _('Allowed') . '</option>';
} else {
		echo  '<option value="1">' . _('Prohibited') . '</option>';
		echo  '<option selected="True" value="0">' . _('Allowed') . '</option>';
}
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Prohibit GL Journals to Periods Prior To') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Inventory Costing Method') . ':</td>
	<td><select name="X_WeightedAverageCosting">';

if ($_SESSION['WeightedAverageCosting']==1){
	echo  '<option selected="True" value="1">' . _('Weighted Average Costing') . '</option>';
	echo  '<option value="0">' . _('Standard Costing') . '</option>';
} else {
	echo  '<option selected="True" value="0">' . _('Standard Costing') . '</option>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Auto Issue Components') . ':</td>
		<td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Prohibit Negative Stock') . ':</td>
		<td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Months of Audit Trail to Retain') . ':</td>
	<td><input type="text" class="number" name="X_MonthsAuditTrail" size="3" maxlength="2" value="' . $_SESSION['MonthsAuditTrail'] . '" /></td>
	<td>' . _('If this parameter is set to 0 (zero) then no audit trail is retained. An audit trail is a log of which users performed which additions updates and deletes of database records. The full SQL is retained') . '</td>
</tr>';

//Which messages to log
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Log Severity Level') . ':</td><td><select name="X_LogSeverity" >';
if ($_SESSION['LogSeverity']==0) {
	echo '<option selected="True" value="0">' ._('None'). '</option>';
	...
	echo '<option selected="True" value="1">' ._('Errors Only'). '</option>';
	echo '<option value="2">' ._('Errors and Warnings'). '</option>';
	echo '<option value="3">' ._('Errors, Warnings and Info'). '</option>';
	echo '<option value="4">' ._('All'). '</option>';
	...
	echo '<option value="0">' ._('None'). '</option>';
	echo '<option value="1">' ._('Errors Only'). '</option>';
	echo '<option selected="True" value="2">' ._('Errors and Warnings'). '</option>';
	echo '<option value="3">' ._('Errors, Warnings and Info'). '</option>';
	echo '<option value="4">' ._('All'). '</option>';
	...
	echo '<option value="1">' ._('Errors Only'). '</option>';
	echo '<option value="2">' ._('Errors and Warnings'). '</option>';
	echo '<option selected="True" value="3">' ._('Errors, Warnings and Info'). '</option>';
	echo '<option value="4">' ._('All'). '</option>';
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Path to log files') . ':</td>
	<td><input type="text" name="X_LogPath" size="40" maxlength="79" value="' . $_SESSION['LogPath'] . '" /></td>
	<td>' . _('The path to the directory where the log files will be stored. Note the apache user must have write permissions on this directory.') . '</td>
</tr>';

//DefineControlledOnWOEntry
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Controlled Items Defined At Work Order Entry') . ':</td>
...
//AutoCreateWOs
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Auto Create Work Orders') . ':</td>
		<td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Default Factory Location') . ':</td>
...
while ($LocationRow = DB_fetch_array($result)){
	if ($_SESSION['DefaultFactoryLocation']==$LocationRow['loccode']){
		echo  '<option selected="True" value="' . $LocationRow['loccode'] . '">' . $LocationRow['locationname'] . '</option>';
	} else {
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Factory Manager Email Address') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Purchasing Manager Email Address') . ':</td>
...
echo '<tr style="outline: solid #A49999 1px"><td>' . _('Inventory Manager Email Address') . ':</td>
