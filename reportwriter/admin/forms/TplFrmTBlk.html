...
<form name="DBRptLine" method="post" action="ReportCreator.php?action=step6a">
  ...
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr>
      ...
      <td><div align="center"><?php echo RPT_TBLFNAME; ?></div></td>
      <td><div align="center"><?php echo RPT_SEPARATOR; ?></div></td>
      <td rowspan="2" align="center"><input name="todo" type="submit" id="todo" value="<?php echo $ButtonValue; ?>"></td>
    </tr>
    <tr>
      <td><div align="center">
      ...
      <td><select name="Processing">
        <?php foreach($TextProcessing as $key => $value) {
			if ($Params['Processing']==$key) $selected = ' selected'; else  $selected = '';
			echo '<option value="'.$key.'"'.$selected.'>'.$value.'</option>';
		} ?></select></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#CCCCCC">
      <td colspan="4"><div align="center"><?php echo RPT_FLDLIST; ?></div></td>
    </tr>
  ...
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr><td colspan="2"><div align="center"><?php echo RPT_BOXDIM; ?></div></td></tr>
	<tr>
