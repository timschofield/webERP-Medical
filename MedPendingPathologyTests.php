...
while ($MyRow = DB_fetch_array($Result)) {
	...
	echo '<tr class="striped_row">
			...
			<td><a href="', $RootPath, '/MedViewPathologyTest.php?Batch=', $MyRow['batch_nr'], '">', _('View Batch'), '</a></td>
			<td><a href="', $RootPath, '/MedEnterPathologyTestResults.php?Batch=', $MyRow['batch_nr'], '">', _('Enter Results'), '</a></td>
		</tr>';
}
...
echo '<div class="centre">
		<a href="', $RootPath, '/MedPathologyLaboratory.php">', _('Return to Pathology Laboratory Centre'), '</a>
	</div>';
