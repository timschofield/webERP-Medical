...
// Print heading if at end of page
		...
		if ($myrow['sectioninaccounts'] != $Section){
			...
			if ($Section != ''){
				...
				if ($Section == 1) { /*Income*/
					...
					$LeftOvers = $pdf->addTextWrap($Left_Margin+370,$YPos,70,$FontSize,locale_money_format(-$SectionPrdBudget, $_SESSION['CompanyRecord']['currencydefault']),'right');
					$LeftOvers = $pdf->addTextWrap($Left_Margin+430,$YPos,70,$FontSize,locale_money_format(-$SectionPrdLY, $_SESSION['CompanyRecord']['currencydefault']),'right');
					$YPos -= (2 * $line_height);
				...
				if ($Section == 2){ /*Cost of Sales - need sub total for Gross Profit*/
					...
					$LeftOvers = $pdf->addTextWrap($Left_Margin+370,$YPos,70,$FontSize,locale_money_format($TotalBudgetIncome - $SectionPrdBudget, $_SESSION['CompanyRecord']['currencydefault']),'right');
					$LeftOvers = $pdf->addTextWrap($Left_Margin+430,$YPos,70,$FontSize,locale_money_format($TotalLYIncome - $SectionPrdLY, $_SESSION['CompanyRecord']['currencydefault']),'right');
					$pdf->line($Left_Margin+310, $YPos+$line_height,$Left_Margin+500, $YPos+$line_height);
					$pdf->line($Left_Margin+310, $YPos,$Left_Margin+500, $YPos);
					$YPos -= (2 * $line_height);
		...
		if ($_POST['Detail'] == 'Detailed') {
			...
			if ($Section == 1) { /*Income*/
				...
				$LeftOvers = $pdf->addTextWrap($Left_Margin+370,$YPos,70,$FontSize,locale_money_format(-$AccountPeriodBudget, $_SESSION['CompanyRecord']['currencydefault']),'right');
				$LeftOvers = $pdf->addTextWrap($Left_Margin+430,$YPos,70,$FontSize,locale_money_format(-$AccountPeriodLY, $_SESSION['CompanyRecord']['currencydefault']),'right');
			} else {
				$LeftOvers = $pdf->addTextWrap($Left_Margin+310,$YPos,70,$FontSize,locale_money_format($AccountPeriodActual, $_SESSION['CompanyRecord']['currencydefault']),'right');
				$LeftOvers = $pdf->addTextWrap($Left_Margin+370,$YPos,70,$FontSize,locale_money_format($AccountPeriodBudget, $_SESSION['CompanyRecord']['currencydefault']),'right');
				$LeftOvers = $pdf->addTextWrap($Left_Margin+430,$YPos,70,$FontSize,locale_money_format($AccountPeriodLY, $_SESSION['CompanyRecord']['currencydefault']),'right');
	...
	$LeftOvers = $pdf->addTextWrap($Left_Margin+370,$YPos,70,$FontSize,locale_money_format(-$PeriodBudgetProfitLoss, $_SESSION['CompanyRecord']['currencydefault']),'right');
	$LeftOvers = $pdf->addTextWrap($Left_Margin+430,$YPos,70,$FontSize,locale_money_format(-$PeriodLYProfitLoss, $_SESSION['CompanyRecord']['currencydefault']),'right');
	$YPos -= (2 * $line_height);
			...
			if ($myrow['parentgroupname']!=$ActGrp AND $ActGrp!=''){
				...
				if ($Section ==1){ /*Income */
						printf('<tr>
							...
							locale_money_format(-$GrpPrdLY[$Level], $_SESSION['CompanyRecord']['currencydefault']));
					} else { /*Costs */
						printf('<tr>
									<td colspan="2"><font size="2"><i>%s </i></font></td>
									<td class="number">%s</td>
		...
		if ($myrow['sectioninaccounts']!= $Section){
			...
			if ($SectionPrdLY+$SectionPrdActual+$SectionPrdBudget !=0){
				if ($Section==1) { /*Income*/
					...
					locale_money_format(-$SectionPrdBudget, $_SESSION['CompanyRecord']['currencydefault']),
					locale_money_format(-$SectionPrdLY, $_SESSION['CompanyRecord']['currencydefault']));
					$TotalIncome = -$SectionPrdActual;
					$TotalBudgetIncome = -$SectionPrdBudget;
					$TotalLYIncome = -$SectionPrdLY;
				} else {
				...
				if ($Section==2){ /*Cost of Sales - need sub total for Gross Profit*/
					...
					locale_money_format($TotalBudgetIncome - $SectionPrdBudget, $_SESSION['CompanyRecord']['currencydefault']),
					locale_money_format($TotalLYIncome - $SectionPrdLY, $_SESSION['CompanyRecord']['currencydefault']));
		...
		if ($_POST['Detail']=='Detailed'){
			...
			if ($Section ==1){
				printf('<td>%s</td>
					...
					locale_money_format(-$AccountPeriodLY, $_SESSION['CompanyRecord']['currencydefault']));
			} else {
				printf('<td>%s</td>
						<td>%s</td>
						<td class="number">%s</td>
	...
	printf('<tr>
		...
		locale_money_format(-$PeriodBudgetProfitLoss, $_SESSION['CompanyRecord']['currencydefault']),
		locale_money_format(-$PeriodLYProfitLoss, $_SESSION['CompanyRecord']['currencydefault'])
		);
