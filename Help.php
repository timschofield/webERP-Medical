...
if (isset($_POST['submit'])) {
	...
	if (strlen($_POST['Narrative']) < 3) {
		$InputError = 1;
		prnMsg( _('The narrative must be a typo it is less than two characters long') . '. ' . _('It was ignored'),'error');
	}
...
if ($ContributeHelpText==true){
	prnMsg(_('The system is set to send a copy of the help text you add here to the developer for inclusion in the project') . '. ' . _('You can turn this option off by setting the ContributeHelpText variable in config.php to false') . '. ' . _('However contributions are sorely needed and your input would be appreciated'),'info');
}
