...
INSERT INTO `audittrail` VALUES ('2008-06-27 20:22:25','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','UPDATE config SET confvalue=\'2006-05-31\' WHERE confname=\'ProhibitPostingsBefore\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (6, \'2007/11/30\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (7, \'2007/12/31\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (8, \'2008/01/31\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:21','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (9, \'2008/02/29\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (10, \'2008/03/31\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (11, \'2008/04/30\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (12, \'2008/05/31\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (13, \'2008/06/30\')');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','DELETE FROM worequirements\n											WHERE wo=5\n											AND parentstockid=\'BREAD\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO worequirements (wo,\n														parentstockid,\n														stockid,\n														qtypu,\n														stdcost,\n														autoissue)\n													SELECT 5,\n														bom.parent,\n														bom.component,\n														bom.quantity,\n														materialcost+labourcost+overheadcost,\n														bom.autoissue\n													FROM bom INNER JOIN stockmaster\n													ON bom.component=stockmaster.stockid\n													WHERE parent=\'BREAD\'\n													AND loccode =\'MEL\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','UPDATE stockmaster SET\n							materialcost=6.0085,\n							labourcost=0,\n							overheadcost=0,\n							lastcost=8.8785\n						WHERE stockid=\'BREAD\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','UPDATE locstock\n						SET quantity = quantity - 0.3\n						WHERE locstock.stockid = \'SALT\'\n						AND loccode = \'MEL\'');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO stockmoves (stockid,\n											type,\n											transno,\n											loccode,\n											trandate,\n											prd,\n											reference,\n											qty,\n											standardcost,\n											newqoh)\n						VALUES (\'SALT\',\n							28,\n							5,\n							\'MEL\',\n							\'2008-06-27\',\n							13,\n							\'5\',\n							-0.3,\n							2.5000,\n							-0.3)');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','UPDATE workorders SET\n						costissued = costissued+0.75\n					WHERE wo=5');
INSERT INTO `audittrail` VALUES ('2008-06-27 20:25:22','demo','INSERT INTO gltrans (type,\n									typeno,\n									trandate,\n									periodno,\n									account,\n									narrative,\n									amount)\n							VALUES (28,\n								5,\n								\'2008-06-27\',\n								13,\n								1440,\n								\'5 - BREAD Component: SALT - 12 x 0.025 @ 2.50\',\n								0.75)');
INSERT INTO `audittrail` VALUES ('2008-06-28 14:32:45','demo','UPDATE suppliers SET suppname=\'Cruise Company Inc\', \n							address1=\'Box 2001\', \n							address2=\'Ft Lauderdale, Florida\', \n							address3=\'\', \n							address4=\'\', \n							suppliersince=\'2005/06/23\',  \n							paymentterms=\'30\', \n							bankpartics=\'\', \n							bankref=\'0\', \n					 		bankact=\'123456789012345678901234567890\', \n							remittance=0, \n							taxgroupid=3,\n							factorcompanyid=1 \n						WHERE supplierid = \'CRUISE\'');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:06:37','demo','INSERT INTO custcontacts (debtorno,contactname,role,phoneno,notes)\r\n				VALUES (\r\n					\'ANGRY\',\r\n					\'Gavin McNulty\',\r\n					\'Purchasing Manager\',\r\n					\'123456567\',\r\n					\'A golfer on 8 handicap\'\r\n					)');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:07:34','demo','UPDATE debtorsmaster SET\n					name=\'Angus Rouledge Younger &amp;amp;amp; Son\',\n					address1=\'P O Box 67\',\n					address2=\'Gowerbridge\',\n					address3=\'Upperton\',\n					address4=\'Michigan\',\n					address5=\'\',\n					address6=\'\',\n					currcode=\'USD\',\n					clientsince=\'2005/04/30\',\n					holdreason=\'1\',\n					paymentterms=\'7\',\n					discount=0,\n					discountcode=\'\',\n					pymtdiscount=0,\n					creditlimit=5000,\n					salestype = \'DE\',\n					invaddrbranch=\'0\',\n					taxref=\'1344-654-112\',\n					customerpoline=\'0\'\n				WHERE debtorno = \'ANGRY\'');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:29:27','demo','UPDATE debtorsmaster SET\n					name=\'Angus Rouledge Younger &amp;amp; Son\',\n					address1=\'P O Box 67\',\n					address2=\'Gowerbridge\',\n					address3=\'Upperton\',\n					address4=\'Michigan\',\n					address5=\'\',\n					address6=\'\',\n					currcode=\'USD\',\n					clientsince=\'2005/04/30\',\n					holdreason=\'1\',\n					paymentterms=\'7\',\n					discount=0,\n					discountcode=\'\',\n					pymtdiscount=0,\n					creditlimit=5000,\n					salestype = \'DE\',\n					invaddrbranch=\'0\',\n					taxref=\'1344-654-112\',\n					customerpoline=\'0\'\n				  WHERE debtorno = \'ANGRY\'');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:30:14','demo','INSERT INTO custcontacts (debtorno,contactname,role,phoneno,notes)\r\n				VALUES (\r\n					\'ANGRY\',\r\n					\'Hamish McKay\',\r\n					\'CEO\',\r\n					\'12334302\',\r\n					\'Whisky drinker single malt only\'\r\n					)');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:31:13','demo','DELETE FROM custcontacts where debtorno=&quot;ANGRY&quot;\n				and contid=&quot;1&quot;');
INSERT INTO `audittrail` VALUES ('2008-06-28 17:31:58','demo','INSERT INTO custcontacts (debtorno,contactname,role,phoneno,notes)\r\n				VALUES (\r\n					\'ANGRY\',\r\n					\'Gavin McDonald\',\r\n					\'Purchasing Manager\',\r\n					\'12334990\',\r\n					\'Golfer, 5 handicap\'\r\n					)');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:06:20','demo','INSERT INTO custcontacts (debtorno,contactname,role,phoneno,notes)\r\n				VALUES (\r\n					\'ANGRY\',\r\n					\'Bill (William) Wallace\',\r\n					\'Mover and shaker\',\r\n					\'10292811\',\r\n					\'English hater!\'\r\n					)');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:07:05','demo','INSERT INTO custcontacts (debtorno,contactname,role,phoneno,notes)\r\n				VALUES (\r\n					\'ANGRY\',\r\n					\'Bob (Robert) Bruce\',\r\n					\'Chairman\',\r\n					\'10292811\',\r\n					\'\'\r\n					)');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:54:00','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:56:12','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_US\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:56:17','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:56:19','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 11:59:40','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:01:10','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'default\',\n					language=\'en_US\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:02:00','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'default\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:02:52','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:03:26','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:46:36','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:46:57','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:47:24','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'en_US\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 12:48:40','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 13:26:48','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 13:29:52','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'en_US\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 13:29:56','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-06-29 13:29:58','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-04 12:04:26','demo','INSERT INTO paymentterms (termsindicator,\n								terms,\n								daysbeforedue,\n								dayinfollowingmonth)\n						VALUES (\n							\'te\',\n							\'test\',\n							2,\n							0\n						)');
INSERT INTO `audittrail` VALUES ('2008-07-04 12:04:30','demo','DELETE FROM paymentterms WHERE termsindicator=\'te\'');
INSERT INTO `audittrail` VALUES ('2008-07-14 21:59:30','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'fresh\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-14 21:59:37','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 17:57:48','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 18:01:04','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 18:02:44','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 18:02:53','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:32:29','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:33:26','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:33:47','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:34:21','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:37:55','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP-utf8\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:38:41','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP.utf8\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:41:17','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:41:25','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP.utf8\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:42:05','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP.utf8\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:44:43','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP.utf8\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-17 19:44:48','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-18 07:48:36','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'de_DE\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-18 07:48:40','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-18 07:49:01','demo','UPDATE paymentterms SET\n					terms=\'Cash Only\',\n					dayinfollowingmonth=0,\n					daysbeforedue=2\n				WHERE termsindicator = \'CA\'');
INSERT INTO `audittrail` VALUES ('2008-07-18 07:59:06','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 13:49:57','demo','UPDATE config \n				SET confvalue=\'2008-07-26\' \n				WHERE confname=\'DB_Maintenance_LastRun\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 13:49:57','demo','DELETE FROM audittrail\n						WHERE  transactiondate &lt;= \'2008-06-26\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 13:50:14','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 14:43:59','demo','INSERT INTO workorders (wo,\n                                                     loccode,\n                                                     requiredby,\n                                                     startdate)\n                                     VALUES (7,\n                                            \'MEL\',\n                                            \'2008-07-26\',\n                                            \'2008-07-26\')');
INSERT INTO `audittrail` VALUES ('2008-07-26 14:45:01','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_US\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 14:45:09','demo','INSERT INTO workorders (wo,\n                                                     loccode,\n                                                     requiredby,\n                                                     startdate)\n                                     VALUES (8,\n                                            \'MEL\',\n                                            \'2008-07-26\',\n                                            \'2008-07-26\')');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:01','demo','UPDATE config SET confvalue=\'2006-06-30\' WHERE confname=\'ProhibitPostingsBefore\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:02','demo','INSERT INTO periods (periodno, lastdate_in_period) VALUES (14, \'2008/07/31\')');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:02','demo','INSERT INTO chartdetails (accountcode, period)\r\n						SELECT chartmaster.accountcode, periods.periodno\r\n							FROM chartmaster\r\n								CROSS  JOIN periods\r\n						WHERE ( chartmaster.accountcode, periods.periodno ) NOT \r\n							IN ( SELECT chartdetails.accountcode, chartdetails.period FROM chartdetails )');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:06','demo','UPDATE config SET confvalue=\'2006-06-30\' WHERE confname=\'ProhibitPostingsBefore\'');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:06','demo','INSERT INTO gltrans (type,\n				 				typeno,\n								trandate,\n								periodno,\n								account,\n								narrative,\n								amount) VALUES (1,\n						2,\n						\'2008/07/26\',\n						14,\n						1350,\n						\'testrg\',\n						500\n						)');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:06','demo','INSERT INTO gltrans ( type,\n							typeno,\n							trandate,\n							periodno,\n							account,\n							narrative,\n							amount) VALUES (1,\n						2,\n						\'2008/07/26\',\n						14,\n						1030,\n						\'\',\n						-500\n					)');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:06','demo','INSERT INTO banktrans (transno,\n					type,\n					bankact,\n					ref,\n					exrate,\n					functionalexrate,\n					transdate,\n					banktranstype,\n					amount,\n					currcode) VALUES (2,\n				1,\n				1030,\n				\'\',\n				1 ,\n				1,\n				\'2008/07/26\',\n				\'Cheque\',\n				-500,\n				\'AUD\'\n			)');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE gltrans SET posted = 1 WHERE counterindex = 58');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET actual = actual + 0.75\n			WHERE accountcode = 1440\n			AND period= 13');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET bfwd = bfwd + 0.75\n			WHERE accountcode = 1440\n			AND period &gt; 13');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE gltrans SET posted = 1 WHERE counterindex = 60');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET actual = actual + -500\n					WHERE accountcode = 1030\n					AND period= 14');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET bfwd = bfwd + -500\n					WHERE accountcode = 1030\n					AND period &gt; 14');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE gltrans SET posted = 1 WHERE counterindex = 59');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET actual = actual + 500\n			WHERE accountcode = 1350\n			AND period= 14');
INSERT INTO `audittrail` VALUES ('2008-07-26 17:18:11','demo','UPDATE chartdetails SET bfwd = bfwd + 500\n			WHERE accountcode = 1350\n			AND period &gt; 14');
INSERT INTO `audittrail` VALUES ('2008-07-28 19:37:18','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'ja_JP\',\n					email=\'\'\n				WHERE userid = \'demo\'');
INSERT INTO `audittrail` VALUES ('2008-07-28 19:41:13','demo','UPDATE www_users\n				SET displayrecordsmax=50,\n					theme=\'silverwolf\',\n					language=\'en_GB\',\n					email=\'\'\n				WHERE userid = \'demo\'');
...
-- Dump completed on 2008-07-29  9:37:15
