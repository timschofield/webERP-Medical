CREATE DATABASE IF NOT EXISTS MyCompanyName DEFAULT CHARACTER SET latin1 DEFAULT COLLATE latin1_swedish_ci;
USE MyCompanyName;
...
CREATE TABLE `www_users` (
  ...
  `language` varchar(10) NOT NULL DEFAULT 'en_GB.latin1',
