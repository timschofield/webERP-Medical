...
$LeftOvers = $pdf->addTextWrap($Page_Width-75,$YPos,75,$FontSize,currency_number_format(round($_SESSION['PaymentDetail']->Amount,$_SESSION['Currencies'][$_SESSION['PaymentDetail']->Currency]['DecimalPlaces']),$_SESSION['PaymentDetail']->Currency), 'left');
...
$LeftOvers = $pdf->addTextWrap(375,$YPos,100,$FontSize, currency_number_format($_SESSION['PaymentDetail']->Amount,$_SESSION['PaymentDetail']->Currency), 'right');
...
$LeftOvers = $pdf->addTextWrap(350,$YPos,75,$FontSize,currency_number_format(round($_SESSION['PaymentDetail']->Amount,$_SESSION['Currencies'][$_SESSION['PaymentDetail']->Currency]['DecimalPlaces']),$_SESSION['PaymentDetail']->Currency), 'left');
