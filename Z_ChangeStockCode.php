...
/* $Id: Z_ChangeStockCode.php 5296 2012-04-29 15:28:19Z vvs2012 $*/

/*Script to Delete all sales transactions*/

include ('includes/session.inc');
$title = _('Change A Stock Code');
...
echo '<div class="centre"><button type="submit" name="ProcessStockChange">' . _('Process') . '</button></div><br />';
