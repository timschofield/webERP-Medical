...
if ($_GET['ProduceCVSFile']==True){
	...
	include('includes/header.inc');
	 ...
	 echo '<P>' . _('You should automatically be forwarded to the CSV Sales Analysis file when it is ready.	If this does not happen') . " <a href='" . $rootpath . '/' . $reports_dir . "/SalesAnalysis.csv'>" . _('click here') . '</a> ' . _('to continue') . '<br>';
	 include('includes/footer.inc');
}
