...
Payment types can be modified by editing that file */
	...
	echo '</table><br /><div class="centre"><button type="submit" name="PrintPDF">' . _('Print PDF Only') . '</button>
                <button type="submit" name="PrintPDFAndProcess">' . _('Print and Process Payments') . '</button></div>';
