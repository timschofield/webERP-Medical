...
/*Show a form to allow input of criteria for TB to show */
	...
	echo '<br /><div class="centre"><button type="submit" name="ShowGraph">' . _('Show Sales Graph') .'</button></div>';
	...
	if ($_POST['SalesArea']=='All'){
		...
		$GraphTitle .= ' ' . _('For') . ' ' . $myrow['areadescription'];
	...
	if ($_POST['CategoryID']=='All'){
		...
		$myrow = DB_fetch_array($result);
		$GraphTitle .= ' ' . _('For') . ' ' . $myrow['categorydescription'];
	...
	if ($_POST['SalesmanCode']=='All'){
		...
		$myrow = DB_fetch_array($result);
		$GraphTitle .= ' ' . _('For Salesperson:') . ' ' . $myrow['salesmanname'];
