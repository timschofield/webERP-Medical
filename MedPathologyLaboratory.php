...
echo '<fieldset class="MenuList">
		...
		<ul>
			<li class="MenuItem">
				<a href="', $RootPath, '/MedPendingPathologyTests.php">', _('Pending Pathology Tests'), '</a>
			</li>
		</ul>
	</fieldset>';
...
echo '<fieldset class="MenuList">
		...
		<ul>
			<li class="MenuItem">
				<a href="', $RootPath, '/MedRequestPathologyTest.php?New=Yes">', _('Request a Pathology Test'), '</a>
			</li>
		</ul>
	</fieldset>';
